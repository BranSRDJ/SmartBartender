...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
		...
		<h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
		  ...
		  <li class="nav-item">
            <a class="nav-link active" href="dash_v_ingredient.php?id=1">
              <span data-feather="bar-chart-2"></span>
              View Ingredients  <span class="sr-only">(current)</span>
            </a>
          </li>
		  <li class="nav-item">
...
$sqlv="SELECT * FROM bar_ingredient LIMIT $start, $limit"; 
...
$rows= mysqli_num_rows(mysqli_query($db,"SELECT * FROM bar_ingredient"));
