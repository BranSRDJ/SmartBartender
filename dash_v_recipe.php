...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
		...
		<h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
		  ...
		  <li class="nav-item">
            <a class="nav-link active" href="dash_v_recipe.php?id=1">
              <span data-feather="bar-chart-2"></span>
              View Recipes <span class="sr-only">(current)</span>
            </a>
          </li>
		  <li class="nav-item">
...
$sqlv="SELECT * FROM bar_reteta LIMIT $start, $limit"; 
...
if (!$resultv)
 ...
 else 
 {
  ...
  echo "<thead class='thead-dark'>
		<tr><th>ID</th><th><b>Recipe ID</th><th>Recipe Name</th></tr>
		</thead>";
...
$rows= mysqli_num_rows(mysqli_query($db,"SELECT * FROM bar_reteta"));
