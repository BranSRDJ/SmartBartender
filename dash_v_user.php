...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
		...
		<h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
		  ...
		  <li class="nav-item">
            <a class="nav-link active" href="dash_v_user.php?id=1">
              <span data-feather="bar-chart-2"></span>
              View Users <span class="sr-only">(current)</span>
            </a>
          </li>
		  <li class="nav-item">
...
$id=$id_Utilizator=$tip_Utilizator=$nume=$email=$parola=$data_Nasterii="";
...
$sqlv="SELECT * FROM bar_utilizator LIMIT $start, $limit"; 
...
if (!$resultv)
 ...
 else 
 {
  ...
  echo "<thead class='thead-dark'>
		<tr><th>ID</th><th>User ID</th><th>User Type</th><th>Name</th><th>Email</th><th>Password</th><th>Birthday</th></tr>
		</thead>";
     ...
     echo $myrow["id"];
      ...
      echo $myrow["parola"];
	  echo "</td><td>";
	  echo $myrow["data_Nasterii"];
	  echo "</td>";
      }
  echo "</table>";
echo "<div class='mx-auto' style='width: 200px;'>";
$rows= mysqli_num_rows(mysqli_query($db,"SELECT * FROM bar_utilizator"));
